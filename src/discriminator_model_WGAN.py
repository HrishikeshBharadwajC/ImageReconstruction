...
class Discriminator(nn.Module):
    def __init__(self):
        super().__init__()
        self.in_channels = 3
        self.conv1 = nn.Conv2d(in_channels=self.in_channels*2, out_channels=64, kernel_size=4, stride=2, padding=1)
        ...
        # self.batch_no rm3 = nn.BatchNorm2d(256)

        self.conv4 = nn.Conv2d(in_channels=256, out_channels=512, kernel_size=4, stride=1, padding=1, bias=False)
